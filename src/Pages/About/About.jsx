    ...
    <div className="about-me container">
      ...
      <section className="about-content">
        ...
        <div className="image-text-container reverse">
          ...
          <div className="product-card">
            <img
              src="/Assets/nayanpottery (1).jpeg"
              alt="Kalibowl Pot"
              className="about-image"
            />
          </div>
        ...
        <div className="video-section">
          <h2 className="text-center">Watch Our Journey</h2>
          <div className="video-container">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/4Y32JFuyoN4" // Standard video URL
              title="Pottery Introduction"
              frameBorder="0"
            ...
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/REQOkK357y0" // Replace with a standard video URL
              title="Another Pottery Introduction"
              frameBorder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            ></iframe>
